...
**USDT**, сеть **Ethereum (ERC-20)**:

```
0xC526C994B2E7e02A5149d73A941869Ec2cE31feA
```

> Отправляйте на этот адрес **только USDT в сети Ethereum** — монета или сеть
> другая, и средства будут потеряны безвозвратно. И учитывайте комиссию
> Ethereum: для небольших сумм она может съесть заметную часть перевода.
